...
def chinese_list_to_encode_by_char(string_list, coding_list=['utf-8'], url_encode=True, de_strip=True, only_chinese=True):
    encode_str_list = []
...
# 对 元组列表 进行中文编码和URL编码
def chinese_encode_tuple_list_by_char(tuple_list, coding_list=["utf8"], url_encode=True, de_strip=True, only_chinese=True):
    new_tuple_list = []
